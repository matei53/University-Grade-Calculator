class GradeService:
    ...
    def calculate_subject_average(
        assessments: list[dict], subject_max_grade: float = 10.0
    ) -> float:
        """
        Calculates the weighted average for a subject, normalizing each
        assessment score to the subject's max grade.
        """
        total_score = 0.0
